...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_block, num_classes=100):
        ...
        self.hadmar32 = Hadmar(32)
        self.hadmar16 = Hadmar(16)
        self.hadmar8 = Hadmar(8)
    ...
    def forward(self, x):
        output = self.hadmar32(x)
        output = self.conv1(output)
        # output = self.hadmar32(output)
        output = self.conv2_x(output)
        # print("got!!!!",output.size())
        # output = output.expand(64,64,4,4)
        # output = self.hadmar32(output)
        output = self.conv3_x(output)
        # output = self.hadmar16(output)
        output = self.conv4_x(output)
        # output = self.hadmar8(output)
